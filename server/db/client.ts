...
export function upsertDailyMetrics(row: DailyMetricsInsert): void {
  ...
  db.prepare(SQL.upsertDailyMetrics).run({
    ...
    avgCycleTimeSeconds: row.avgCycleTimeSeconds,
    medianCycleTimeSeconds: row.medianCycleTimeSeconds,
    p95CycleTimeSeconds: row.p95CycleTimeSeconds,
...
function rowToDailyMetrics(row: Record<string, unknown>): DailyMetricsRow {
  return {
    ...
    avgCycleTimeSeconds: row.avg_cycle_time_seconds != null ? Number(row.avg_cycle_time_seconds) : null,
    medianCycleTimeSeconds: row.median_cycle_time_seconds != null ? Number(row.median_cycle_time_seconds) : null,
    p95CycleTimeSeconds: row.p95_cycle_time_seconds != null ? Number(row.p95_cycle_time_seconds) : null,
